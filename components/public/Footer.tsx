  ...
  return (
    <footer className="win95-outset bg-win95-bg mt-8">
      <div className="max-w-5xl mx-auto px-4 py-3 flex flex-col md:flex-row items-center justify-between gap-2">
        <div className="text-xs font-mono text-win95-gray">
          Visitors: 0000420 | Since 2023
        </div>
        <div className="text-xs">
          <span className="animate-blink text-win95-red font-bold">NEW!</span>{" "}
          <span className="text-win95-gray">Yuan Website v2.0</span>
        </div>
        <div className="text-xs text-win95-gray">
          Made with ❤️ and Windows 95
        </div>
      </div>
