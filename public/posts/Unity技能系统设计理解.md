...
![](Unity技能系统设计理解/diagram-1.png)



**GAS的运行逻辑**

![源自EX-GAS文档](Unity技能系统设计理解/image-6.png)
...
![来自Gasify的Wiki文档](Unity技能系统设计理解/image-7.png)

**Attributes，Tags，GameplayEffects，GameplayAbility**都应用于ASC，也就是说ASC持有这些东西的**容器，以下是EX-GAS和GASify的ASC的源码**

![EX-GAS的ASC源码](Unity技能系统设计理解/image-8.png)

![GASify的ASC源码](Unity技能系统设计理解/image-9.png)
